...
parser.add_argument('--input_dir', default='imgs/input', type=str, help='Directory of validation images')
parser.add_argument('--output_dir', default='imgs/output', type=str, help='Directory of validation images')
parser.add_argument('--weights', default='weights/nerd_self_s.pth', type=str, help='Path to weights') 
